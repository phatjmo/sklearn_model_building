...
print "Step 3: Load Magic Bus data."
# Load MB data from CSV
mbdata = './MBDataWithSerenity_cleaned.csv'
# data = pd.read_csv(dataset_url)
# Read CSV with semicolon separator
data = pd.read_csv(mbdata, nrows=1000) # <-- limit load to 10,000 while we test!
...
joblib.dump(clf, 'mbdata_rf_regressor.pkl')

# Load model from .pkl file
clf2 = joblib.load('mbdata_rf_regressor.pkl')
